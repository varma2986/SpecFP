...
%data1 = load('cpufp_8_version_bitmap.csv');
%data2 = load('cpufp_9_version_bitmap.csv');
data = load('cpufp_8_9_version_bitmap.csv');
%data = [data1;data2];
...
X_compiler_version_8_square = (data(:,11) .^ 2);
X_compiler_version_9_square = (data(:,12) .^ 2);

%X = [X X_cores_per_chip X_l1ic_sigmoid X_l1dc_sigmoid X_l2c_sigmoid X_ddr_size_sigmoid X_l1dc_freq_sqrt X_l3c_freq]
%X = [X X_cores_per_chip X_l1ic_sigmoid X_l1dc_sigmoid X_l2c_sigmoid X_ddr_size_sigmoid X_l1dc_freq_sqrt X_l3c_freq ]
X = [X X_cores_per_chip X_l1ic_sigmoid X_l1dc_sigmoid X_l2c_sigmoid X_ddr_size_sigmoid X_l1dc_freq_sqrt X_l1ic_freq X_allcache_freq X_l3c_freq X_ddrsize_ddrfreq X_cores_freq X_compiler_version_8_square X_compiler_version_9_square ]; 
